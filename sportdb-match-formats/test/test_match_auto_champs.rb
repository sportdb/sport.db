...
TXT
    ...
    clubs, rounds, groups, round_defs, group_defs = parse_auto_conf( txt, lang: 'en' )
...
TXT
  ...
  clubs, rounds = parse_auto_conf( txt, lang: 'en' )
 ...
 'Roma'=>6,
 'Sevilla'=>4,
 'Manchester United'=>2 ), clubs

   assert_equal Hash(
     'Round of 16 - 1st Leg'    => {:count=>1, :match_count=>8},
     'Round of 16 - 2nd Leg'    => {:count=>1, :match_count=>8},
     'Quarter-finals - 1st Leg' => {:count=>1, :match_count=>4},
     'Quarter-finals - 2nd Leg' => {:count=>1, :match_count=>4},
     'Semi-finals - 1st Leg'    => {:count=>1, :match_count=>2},
     'Semi-finals - 2nd Leg'    => {:count=>1, :match_count=>2},
