...
require 'mono'    ## todo/check: keep reference to mono - why? why not?



### todo/fix:
##    check min version of mono ??
...
module SportDb
module Boot
  def self.root()  Mono.root; end  ## todo/check: keep reference to mono - why? why not?
