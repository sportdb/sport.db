...
Gem::Specification.new do |s|
  ...
  s.files = ["History.md", "Manifest.txt", "README.md", "Rakefile", "bin/sportdb", "config/fixtures.de.yml", "config/fixtures.en.yml", "config/fixtures.es.yml", "config/fixtures.pt.yml", "lib/sportdb.rb", "lib/sportdb/cli/main.rb", "lib/sportdb/cli/opts.rb", "lib/sportdb/console.rb", "lib/sportdb/data/fixtures.rb", "lib/sportdb/data/keys.rb", "lib/sportdb/data/models.rb", "lib/sportdb/deleter.rb", "lib/sportdb/lang.rb", "lib/sportdb/models/badge.rb", "lib/sportdb/models/city.rb", "lib/sportdb/models/country.rb", "lib/sportdb/models/event.rb", "lib/sportdb/models/event_team.rb", "lib/sportdb/models/forward.rb", "lib/sportdb/models/game.rb", "lib/sportdb/models/group.rb", "lib/sportdb/models/group_team.rb", "lib/sportdb/models/league.rb", "lib/sportdb/models/prop.rb", "lib/sportdb/models/region.rb", "lib/sportdb/models/round.rb", "lib/sportdb/models/season.rb", "lib/sportdb/models/team.rb", "lib/sportdb/reader.rb", "lib/sportdb/schema.rb", "lib/sportdb/stats.rb", "lib/sportdb/utils.rb", "lib/sportdb/version.rb", "tasks/test.rb"]
