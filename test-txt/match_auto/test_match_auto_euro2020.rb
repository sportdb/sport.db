###
#  to run use
#     ruby match_auto/test_match_auto_euro2020.rb


require_relative '../helper'


class TestMatchAutoEuro2020 < Minitest::Test

  def test_euro_2020
    txt, exp = read_test( 'match_auto/euro_2020.txt')
...
end   # class TestMatchAutoEuro2020
