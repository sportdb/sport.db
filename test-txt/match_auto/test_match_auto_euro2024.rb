###
#  to run use
#     ruby match_auto/test_match_auto_euro2024.rb


require_relative '../helper'


class TestMatchAutoEuro2024 < Minitest::Test

  def test_euro_2024
    txt, exp = read_test( 'match_auto/euro_2024.txt')
...
end   # class TestMatchAutoEuro2024
